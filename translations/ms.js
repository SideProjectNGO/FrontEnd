export default {
    header: {
        tagline: "Setiap Kanak-Kanak adalah Anak Saya",
        nav: {
            home: "Laman Utama",
            about: "Tentang Kami",
            articles: "Artikel",
    ...
    articles: {
        new_article: {
            ...
            placeholder: {
                title: "Masukkan tajuk artikel",
                content: "Masukkan kandungan artikel",
                summary: "Masukkan ringkasan artikel",
                author_name: "Masukkan nama penulis",
                author_country: "Pilih negara penulis",
            },
            validation: {
    ...
    activities: {
        new_activity: {
            ...
            placeholder: {
                title: "Masukkan tajuk aktiviti",
                content: "Masukkan kandungan aktiviti",
                summary: "Masukkan ringkasan aktiviti",
                author_name: "Masukkan nama penulis",
                author_country: "Pilih negara penulis",
            },
            validation: {
